...
def load_checkpoints(config_path, checkpoint_path, cpu=False):
    ...
    if not cpu:
        inpainting = inpainting.cuda()
        kp_detector = kp_detector.cuda()
        bg_predictor = bg_predictor.cuda()
        dense_motion_network = dense_motion_network.cuda()
    ...
    return inpainting, kp_detector, bg_predictor, dense_motion_network


def evaluate(eval_loader, inpainting, kp_detector, bg_predictor, dense_motion_network):
...
if __name__ == "__main__":
    ...
    inpainting, kp_detector, bg_predictor, dense_motion_network = load_checkpoints(opt.config, opt.checkpoint)
    ...
    evaluate(eval_loader, inpainting, kp_detector, bg_predictor, dense_motion_network)
